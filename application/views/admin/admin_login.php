...
<div class="logo">
    <a href="index.html">
        <img src="<?php echo base_url()?>admin_assets/pages/img/logo-big.png" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <?php $message = "Enter username and password.";
...
<?php  $this->session->unset_userdata('message');    }?>
    ...
    <form class="login-form" action="<?php echo base_url();?>admin_login/check_admin_login" method="post">
        <h3 class="form-title" style="color: green; text-align: center ">Login to your account</h3>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn green center-block"> Login </button>
        </div>
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> Developed by <a href="http://www.ithaat.com"> IT Haat </a> </div>
<!-- END COPYRIGHT -->
<!--[if lt IE 9]>
...
<script src="<?php echo base_url()?>admin_assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="<?php echo base_url()?>admin_assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url()?>admin_assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
